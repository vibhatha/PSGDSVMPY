...
for dataset, feature, split in zip(datasets, features, splits):
    ...
    beta1_range = [0.5]
    beta2_range = [0.5]
    alphas = [alpha]#[0.1, 0.01, 0.001, 0.0001, 0.000001, 0.2, 0.02, 0.002, 0.0002, 0.00002, 0.000002, 1]
            ...
            for alpha in alphas:
                for repition in repetitions:
                    ...
                    w_final_adam, epochs_eff_adam, initial_cost_adam, final_cost_adam, overall_training_time_adam = bmsvmsgdadam.train_benchmark_light(
                        ...
                        log_file=log_file_adam, tolerance=tolerance, indices_init=indices_init, beta1=b1, beta2=b2, alpha=alpha)
