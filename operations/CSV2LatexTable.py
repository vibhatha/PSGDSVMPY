##################################################################################
###### References : https://github.com/joards/python-csv-to-latex-table-script####
##################################################################################
...
class Csv2LatexTable:
    def __init__(self, inputFile, delimiter, quotechar, tablepos, cap, reflable, noUnderLine, tableSpec, longTable,
                 lessSpacing):
...
if __name__ == "__main__":
    ...
    c2lt = Csv2LatexTable(args.inputFile, args.delimiter, args.quotechar, args.tablePos, args.caption, args.refLable,
                          args.noUnderLine, args.tableSpec, args.longTable, args.lessSpacing)
